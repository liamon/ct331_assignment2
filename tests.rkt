...
(define (runTests)
  (begin
    ...
    (display (test_result_message test_count_instances_tr_absent
                                  "Counting instances of an item absent from a list with tail-recursion"))
    (display (test_result_message test_count_instances_tr_present
                                  "Counting instances of an item present in a list with tail-recursion"))

    (display (test_result_message test_count_instances_deep_absent "Deep counting instances of an item absent from a list"))
    (display (test_result_message test_count_instances_deep_present "Deep counting instances of an item present in a list"))
    (display (test_result_message test_count_instances_deep_absent_sublists
                                  "Deep counting instances of an item absent from a list with sublists"))
    (display (test_result_message test_count_instances_deep_present_sublists
                                  "Deep counting instances of an item present in a list with sublists"))
